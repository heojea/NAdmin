//alert("load editor_loader.js");
//var imageUploadPopUrl = "/Themis/editor/image.html";
//var imageUploadPopUrl = "http://localhost:9002/Themis/view.do?viewName=editorImage&layout=common";
(function() {
    var w = document, g = window, E = w.documentElement, J = false, t = true, u = null, l;
    var G = "", j = "tx_", f = "uninitialized", L = "loading", a = "complete", x = "production", K = "development", C = "EDR_ST", q = 1000, s = 5;
    ...
    function k(O) {
        ...
        N.src = "http://rialog.daum-img.net:8080/editor_error/?service=" + M
                + "&" + O
    }
    var v = function(M) {
        this.TIMEOUT = s * q;
    ...
    var H = {
        ...
        loadModule : function(N) {
            ...
            /*
            alert(M);
            alert("getBasePath : " + this.getBasePath());
            alert("getJSBasePath : " + this.getJSBasePath());
            alert("getCSSBasePath : " + this.getCSSBasePath());
            alert("getPageBasePath : " + this.getPageBasePath());
            */
            
            w.write('<script type="text/javascript" src="' + M
        ...
        getJSBasePath : function(M) {
            return this.getBasePath() + "js/editor/"
        },
        getCSSBasePath : function() {
            return this.getBasePath() + "css/editor/"
        },
        getPageBasePath : function() {
            return this.getBasePath() + "pages/editor/"
        },
