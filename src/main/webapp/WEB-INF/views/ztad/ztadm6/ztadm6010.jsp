...
$(document).ready(function() {
    ...
    $('#f_admin').validate({
        rules: {
            ...
            i_pwd: {required:true, equalTo: '#i_pwd_confirm', minlength:4, maxlength: 100},
            i_pwd_confirm: {required:true, minlength:4, maxlength: 100},
...
function doSearch() {
    $.ajax({
        type: 'POST',
        url: "<c:url value='/ztad/ztadm601/adminList.json'/>",
...
function modifyAdmin() {
    ...
    $.ajax({
        type: 'POST',
        url: "<c:url value='/ztad/ztadm601/updateAdmin.json'/>",
...
function removeAdmin() {
    ...
    $.ajax({
        type: 'POST',
        url: "<c:url value='/ztad/ztadm601/deleteAdmin.json'/>",
        data: formSerialize("#f_admin"),
        dataType: 'json',
        success: function(data) {
            if (data) {
...
function loadAdmin(aid) {
    $.ajax({
        type: 'POST',
        url: "<c:url value='/ztad/ztadm601/admin.json'/>",
        data: 'admin_id='+aid,
        dataType: 'json',
        success: function(data) {
            var item = eval(data);
...
<div id="wrap">
    ...
    <div class="tab">
        <ul>
            ...
            <li id="tab2_top" class="off"><span><a href="#" id="">관리자 수정</a></span></li>
        </ul>
    </div>
    ...
    <div id="tab2_page">
        <div class="bbs_search">
            ...
            <tr>
                ...
                <td>
                    <select name="i_admin_tp_cd" id="i_admin_tp_cd">
            ...
            <tr>
                <th>사번</th>
                <td><input type="text" name="i_emp_no" id="i_emp_no" class="text" style="width:150px"/></td>
