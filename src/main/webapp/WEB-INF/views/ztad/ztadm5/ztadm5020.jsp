...
$(document).ready(function() {
    ...
    $('#f_templete').validate({
        rules: {
            ...
            i_temp_subject_nm: {required:true, maxlength:50},
        ...
        success: function(data) {
            ...
            if (list) {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    //$("<td></td>").html('<a href="javascript:popEmail(\''+item.TEMP_NO+'\');" class="btn" id="btn_send_mail"><span>이메일보내기</span></a>').appendTo(tr);
...
function loadTemplete(rid) {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#i_temp_subject_nm').val(item.TEMP_SUBJECT_NM);
    ...
    <div id="tab1_page">
        <div class="bbs_search">
            <form name="f_cond" id="f_cond" onsubmit="return false">
               <input type="hidden" name="s_temp_tp_cd" id="s_temp_tp_cd" value="20" />
        ...
        <div class="bbs_search">
            ...
            <tr>
                ...
                <td><input type="text" name="i_temp_nm" id="i_temp_nm" class="text" style="width:350px"/>
                    ...
                    <input type="hidden" name="i_temp_tp_cd" id="i_temp_tp_cd" value="20" />
                </td>
            </tr>
            <tr>
                <th class="point">템플릿제목</th>
                <td><input type="text" name="i_temp_subject_nm" id="i_temp_subject_nm" class="text" style="width:350px"/>
                </td>
            </tr>
            <tr>
                <th>템플릿내용</th>
                <td><textarea name="i_temp_content" id="i_temp_content" style="width:100%" rows="45"></textarea></td>
            </tr>
            </tr>
            <tr>
