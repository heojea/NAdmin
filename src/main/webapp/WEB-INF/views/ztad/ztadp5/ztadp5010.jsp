...
function sendTemplete() {
    ...
    $.ajax({
        type: 'POST',
        url: "<c:url value='/ztad/ztadp501/sendTemplete.json'/>",
...
function loadTemplete(rid) {
    $.ajax({
        type: 'POST',
        url: "<c:url value='/ztad/ztadp501/templete.json'/>",
        data: 'temp_no='+rid,
        dataType: 'json',
        success: function(data) {
            var item = eval(data);
...
<div style="min-width:0px; width:775px;">
    ...
    <div class="bbs_search">
        ...
        <tr>
            ...
            <td>
                <div id="d_temp_content" style="width:100%;height:260px;overflow:auto;"></div>
            </td>
        </tr>
        <tr>
            <th>발송대상</th>
        ...
        <tr>
            <td colspan="2" class="center">
                <a href="#" class="btn_s" id="btn_send"><span>SMS발송</span></a>
            </td>
        </tr>
        </tbody>
        </table>
