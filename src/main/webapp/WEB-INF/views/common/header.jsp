...
}).ajaxError(function( event, jqxhr, settings, thrownError ) {   //session checedc logout logic
	if(jqxhr.responseText == "loginOut"){
		alert("session expire Logout");
